package kyu7;
//https://www.codewars.com/kata/559e3224324a2b6e66000046/train/java
...
public class Funcij {
    public static void main(String[] args) {
        System.out.println(sumin(5000));
        System.out.println(sumax(5000));
        System.out.println(sumsum(5000));
    }
    ...
    public static BigInteger sumin(int n) {
        ...
        for (int i = 1; i < n + 1; i++) {
            for (int j = 1; j < n + 1; j++)
                if (i < j) bigInteger = bigInteger.add(BigInteger.valueOf(i));
                else bigInteger = bigInteger.add(BigInteger.valueOf(j));
        }
        return bigInteger;
    }
    ...
    public static BigInteger sumsum(int n) {
        ...
        for (int i = 1; i < n + 1; i++)
            for (int j = 1; j < n + 1; j++)
                bigInteger = bigInteger.add(BigInteger.valueOf(i).add(BigInteger.valueOf(j)));
        return bigInteger;
    }
}